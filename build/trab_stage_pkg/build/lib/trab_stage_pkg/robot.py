...
class Robot(Node):
    def __init__(self):
        ...
        # --- Parâmetros da Estratégia e do Controlador PD ---
    ...
    def wall_follower_strategy(self):
        ...
        omega = -self.turn_speed # Vira para a direita para encontrar a parede
        return v, omega
    ...
    def _callback_odom(self, msg):
        ...
        self.get_logger().info(f"Estimated Pose: x:{world_x} | y:{world_y} | z:{world_yaw}")
